<%-- 
    Document   : index
    Created on : 18 de jun. de 2022, 13:12:06
    Author     : luisg
--%>
...
<html>
    <head>
        ...
        <title>Cartão | C'Wallet</title>
       
    </head>
    <body>
         <form method="POST" action='ControllerCartao' name="frmDadosCartao">
            <table>
                <tbody>
                    <tr>
                        <td>Id:</td>
        ...
        <form method="GET" action='ControllerCartao' name="frmTabelaCartao">
            <table border=1>
            <thead>
                <br>
                    <tr>
